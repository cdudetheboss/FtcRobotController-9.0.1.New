...
@Autonomous(name= "RedLeft2+0", group="14174")
//@Disabled//comment out this line before using
public class Center_Stage_AutoRL2_0 extends LinearOpMode {
        ...
        while (opModeIsActive()) {
            ...
            if(valLeft == 255 && valRight == 0) {
                ...
                if (opState == 1 && opModeIsActive()) { //test of straight drive 100,0.5,10,0,10
                    ...
                    sleep(350);
                    turn(0, 0.4, 3);
                    driveSBTest(875, 0.4, 3, 0, 5);
                    sleep(500);
                    turn(-90, 0.3, 4);
                    sleep(350);
                    driveSBTest(3285, 0.5, 5, -90, 5);
                    sleep(5400);
                    robot.slidesrot.setTargetPosition(slidesup);
                    robot.slidesrot.setPower(0.5);
                    driveLRTest(1075, 0.4, 3, -90, 4);
                    sleep(300);
