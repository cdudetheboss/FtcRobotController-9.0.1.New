...
@Autonomous(name= "BlueRight2+0", group="14174")
//@Disabled//comment out this line before using
public class Center_Stage_AutoBR2_0 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.slides.setDirection(DcMotorSimple.Direction.FORWARD);
        robot.slidesrot.setDirection(DcMotorSimple.Direction.FORWARD);
        ...
        //slides motor stuff
        robot.slidesrot.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        robot.slidesrot.setTargetPosition(slidesdown);
        robot.slidesrot.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        ...
        robot.slidesrot.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        ...
        while (opModeIsActive()) {
            ...
            if(valLeft == 255 && valRight == 0) {
                ...
                if (opState == 1 && opModeIsActive()) { //test of straight drive 100,0.5,10,0,10
                    driveSBTest(1030, 0.4, 5, 0, 5);
                    sleep(500);
                    driveSBTest(-140, 0.4, 5, 0, 5);
                    sleep(350);
                    turn(-90, 0.4, 3);
                    sleep(100);
                    driveSBTest(500, 0.4, 3, -90, 5);
                    sleep(350);
                    turn(0, 0.4, 3);
                    driveSBTest(950, 0.4, 3, 0, 5);
                    sleep(500);
                    turn(90, 0.3, 4);
                    sleep(350);
                    driveSBTest(3400, 0.5, 5, 90, 5);
                    sleep(4000);
                    robot.slidesrot.setTargetPosition(slidesup);
                    robot.slidesrot.setPower(0.5);
                    sleep(750);
                    driveLRTest(-975, 0.4, 3, 90, 4);
                    sleep(300);
                    driveSBTest(200, 0.3, 5, 90, 5);
            ...
            if(valLeft == 0 && valRight == 255) {
                ...
                if (opState == 1 && opModeIsActive()) { //test of straight drive 100,0.5,10,0,10
                    turn(-25, 0.4, 3);
                    sleep(200);
                    driveSBTest(925, 0.4, 5, -25, 3);
                    sleep(500);
                    driveSBTest(-925, 0.4, 5, -25, 5);
                    sleep(350);
                    turn(0, 0.4, 2);
                    sleep(200);
                    driveSBTest(1650, 0.4, 5, 0, 4);
                    sleep(200);
                    turn(90, 0.4, 3);
                    sleep(200);
                    ...
                    robot.slidesrot.setTargetPosition(slidesup);
                    robot.slidesrot.setPower(0.5);
                    driveLRTest(-575, 0.4, 3, 90, 5);
                    sleep(200);
                    driveSBTest(100, 0.5, 5, 90, 5);
                    sleep(600);
                    robot.slides.setPower(0.8);
                    robot.collection.setPosition(0.26);
                    sleep(1000);
            ...
            if(valLeft == 0 && valRight == 0) {
                ...
                if (opState == 1 && opModeIsActive()) { //test of straight drive 100,0.5,10,0,10
                    ...
                    turn(44, 0.4, 3);
                    sleep(100);
                    driveSBTest(400, 0.55, 3, 44, 4);
                    sleep(300);
                    driveSBTest(-400, 0.55, 3, 44, 4);
                    sleep(300);
                    turn(0, 0.4, 3);
                    sleep(250);
                    driveSBTest(1200, 0.4, 3, 0, 5);
                    sleep(150);
                    turn(90, 0.4, 3);
                    sleep(100);
                    driveSBTest(2700, 0.5, 3, 90, 12);
                    sleep(6250);
                    robot.slidesrot.setTargetPosition(slidesup);
                    robot.slidesrot.setPower(0.5);
                    driveLRTest(-1200, 0.5, 3, 90, 2);
                    sleep(300);
                    driveSBTest(450, 0.4, 5, 90, 5);
                    robot.slides.setPower(0.8);
                    robot.collection.setPosition(0.26);
                    sleep(1050);
                    robot.slides.setPower(0);
