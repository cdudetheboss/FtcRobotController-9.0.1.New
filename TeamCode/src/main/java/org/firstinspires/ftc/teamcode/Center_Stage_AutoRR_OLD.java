...
@Autonomous(name= "RedRight2+0 (old)", group="14174")
//@Disabled//comment out this line before using
public class Center_Stage_AutoRR_OLD extends LinearOpMode {
        ...
        while (opModeIsActive()) {
            ...
            if(valLeft == 255 && valRight == 0) {
                ...
                if (opState == 1 && opModeIsActive()) { //test of straight drive 100,0.5,10,0,10
                    ...
                    sleep(500);
                    driveSBTest(-950, 0.3, 5, 0, 5);
                    sleep(350);
                    turn(-90, 0.3, 4);
                    sleep(200);
                    driveSBTest(950, 0.4, 5, -90, 5);
                    sleep(300);
                    turn(0, 0.4, 4);
            ...
            if(valLeft == 0 && valRight == 0) {
                ...
                opState++;
                if (opState == 1 && opModeIsActive()) { //test of straight drive 100,0.5,10,0,10
                    driveSBTest(575, 0.4, 5, 0, 5);
                    sleep(500);
                    turn(40, 0.35, 3);
                    sleep(200);
                    driveSBTest(415, 0.4, 3, 40, 4);
                    sleep(300);
                    driveSBTest(-415, 0.4, 3, 40, 4);
                    sleep(300);
                    turn(0, 0.4, 3);
                    sleep(250);
                    driveSBTest(-395, 0.4, 5, 0, 5);
                    sleep(350);
                    turn(-90, 0.3, 4);
                    sleep(100);
